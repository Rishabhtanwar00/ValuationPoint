		...
		>
			<div className='landing-container'>
				<div className='content'>
					<h1 className=''>Valuation Point</h1>
				...
				<div className='tagline-content'>
					<div className='tagline-text'>
						...
						<Fade direction='left' delay='0.2s'>
							<p>
								Valuation Point offers comprehensive business support services,
								streamlining the acquisition of all necessary financial
								documents within a remarkably short timeframe of 12 hours. We
								have established partnerships with experienced CAs and
